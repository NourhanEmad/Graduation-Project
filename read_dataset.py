...
def main(mode):
    ...
    if mode == "duplication":
        ...
        new_total_words = pad_sequences(total_words, padding='pre')
...
#    print("**Wild Model:")
#    wild_model.training_model(padded_total_words, y_labels_encoded, num_of_classes, one_hot_encoder, y_label_encoder)
...
def testing(mode):
    ...
    total_words_test = total_words.copy()
